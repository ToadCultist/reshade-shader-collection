...
uniform bool VHS_Filter <
	...
	ui_tooltip = "Filters the image linearly, increasing quality.\n\nIn order to use this setting as shown, please install the \"UIBind\" addon created by cot6.\n\nAlternatively, you may enable linear filtering in the Preprocessor Definitions below by adjusting VHSLINEARFILTER to 1";
